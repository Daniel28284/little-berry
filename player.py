        ...
        try:
            ...
            while True: 
                ...
                if videoAtual != nDoVideo:  # verifica se o número do vídeo mudou para evitar reinicializações desnecessárias
                    ...
                    if nDoVideo == 0:
                        url = 0  # inserir o URL de um vídeo de carregamento,OLAFEDFSFGSUGFSFHGIUEFHUEFHSUFHSUFHSUFIFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                    elif nDoVideo == 1:
                    ...
                    time.sleep(1)  # aguarda para evitar reinicializações rápidas
